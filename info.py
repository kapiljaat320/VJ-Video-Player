...
ADMIN = int(environ.get('ADMIN', '6312174113'))
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002685290693'))
...
LINK_URL = environ.get("LINK_URL", "https://bhakarplay.blogspot.com/p/m.html")
